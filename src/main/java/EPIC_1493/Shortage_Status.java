...
public class Shortage_Status extends UtilClass {
	...
	public void Shortage_Status_Update() throws JsonProcessingException, IOException, JSONException {
		...
		jsonObject.put("StatusEvent", Status_Events[3]);
	...
	public Shortage_Status(WebDriver driver) {
...
//	public static WebElement pyWorkPage;
	...
	@FindBy(xpath = "(//a[contains(text(), 'StatusEventDateTime')]/ancestor::tr)[3]//td[2]//div//span")
	public static WebElement ReceivedDate_OrderPage_Clipboard;

	@FindBy(xpath = "(//a[@title='Expand to show child rows'])[23]")
	public static WebElement ExpandOrderPageinClipboard;

	@FindBy(xpath = "((//span[contains(text(), 'OrderPage (ESTES-Data-Order)')]/ancestor::li)[3]//ul//li//div//div//a)[1]")
	...
	public static WebElement Shortage_Status_in_Status_Datatype;
...
//		CLickonDataType.click();
		...
		frameswitch3();
		Thread.sleep(5000);
//		clickIgnoringStaleElementException(PickAndReleaseRefresh);

		PickAndReleaseRefresh.click();

		// clickIgnoringStaleElementException(ClickonIdFilter);
		Await();
...
//		Date date1 = format1.parse(GetReceivedDate);
		...
		assertTrue(text.contains("Shortage"));
		...
		assertTrue(text2.contains("Shortage"));
...
//		pyWorkPage.click();	
		...
		assertTrue(Status_Shipment2.contains("Shortage"));
...
//		frameswitch3();
		...
		Await();
		getIgnoringStaleElementException(Shortage_Status_in_Status_Datatype);
		String ReceivedStatus_Status_Datatype = Shortage_Status_in_Status_Datatype.getText();
		assertTrue(ReceivedStatus_Status_Datatype.contains("Shortage"));
		System.out
		...
		System.out.println(
				"Successfully Validated Status_Date_Time_in_Status_Datatype:" + Status_Date_Time_Status_Datatype);
