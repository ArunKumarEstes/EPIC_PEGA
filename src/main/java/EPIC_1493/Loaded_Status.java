...
public class Loaded_Status extends UtilClass {
	...
	public void Loaded_Status_Update() throws JsonProcessingException, IOException, JSONException {
	...
	public Loaded_Status(WebDriver driver) {
	...
	@FindBy(xpath = "//iframe[contains(@name,PegaGadget) and contains(@title,'Pickup And Release') or contains(@title,'Estes')]")
	public static WebElement MainPEGAFrame;
...
//	@FindBy(xpath = "//table[@class='gridTable ']/tbody/tr[@class='oddRow cellCont']/td[@class='dataValueRead gridCell  wrapText ']/div[13]")
//	public static WebElement ReceivedDate_OrderPage_Clipboard;
	...
	public static WebElement Loaded_Status_in_Status_Datatype;
	...
	@FindBy(xpath = "(//table[@id='RULE_KEY'][1]//td[2]//span)[1]")
	public static WebElement ElementtoClosePegatab;

	@FindBy(xpath = "(//span[@title='Close this tab'])[1]")
	public static WebElement ClosePegatab;
	...
	public static void MainFrame() {
		driver.switchTo().frame(MainPEGAFrame);
	}
...
//		pyWorkPage.click();	
		...
		Await();
		getIgnoringStaleElementException(ReceivedDate_OrderPage_Clipboard);
...
//		assertEquals(dateActual, dateExpected);
		...
		System.out.println("Successfully Validated LoadedStatus_in_Order_Clipboard:" + text);
		extentTest.log(Status.PASS, "Successfully Validated Loaded_Status_in_Order_Clipboard");
		...
		assertTrue(text2.contains("Loaded"));
		System.out.println("Successfully Validated Loaded_Status_in_Shipment2_Clipboard:" + text2);
		extentTest.log(Status.PASS, "Successfully Validated Loaded_Status_in_Shipment2_Clipboard");
		...
		extentTest.log(Status.PASS, "Successfully Validated OutboundTrackingNumber");
...
//		pyWorkPage.click();	
		...
		extentTest.log(Status.PASS, "Successfully Validated Status in Clipboard OrderPage");
		...
		String Status_Shipment2 = StatusEvent_Shipement2_Clipboard.getText();
		assertTrue(Status_Shipment2.contains("Loaded"));
		System.out.println("Successfully Validated Status:" + Status_Shipment2);
		extentTest.log(Status.PASS, "Successfully Validated Loaded Status");
...
//		frameswitch3();
	...
	//	waits(Loaded_Status_in_Status_Datatype);
		Await();
		getIgnoringStaleElementException(Loaded_Status_in_Status_Datatype);
		String ReceivedStatus_Status_Datatype = Loaded_Status_in_Status_Datatype.getText();
		assertTrue(ReceivedStatus_Status_Datatype.contains("Loaded"));
		System.out
	...
	//	waits(Event_Location_Address_in_Status_Datatype);
		Await();
